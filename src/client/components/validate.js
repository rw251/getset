...
<div class="container">
  ${!user || !user.profile
    ...
    <h1>Validate</h1>
    <p>
      Check out how other people created their code sets. You can
      <ul>
        <li>Upload a code set created with this tool to check it is error free</li>
        <li>Begin to extend other people's code sets</li>
        <li>Compare different code sets to spot differences</li>
      </ul>However for all of this you need to..
    </p>
    <p><a class="btn btn-github btn-social" href="/auth/github?returnTo=/validate"><i class="fab fa-github"></i>sign in with GitHub </a></p>
    <p>..to see more.</p>`
    : `
...
//       | Check out how other people created their code sets. You can
//       ul
//         li Upload a code set created with this tool to check it is error free
//         li Begin to extend other people's code sets
//         li Compare different code sets to spot differences
//       | However for all of this you need to..
//     p
//       a.btn.btn-github.btn-social(href='/auth/github?returnTo=/validate')
//         i.fa.fa-github
//         | sign in with GitHub
//     p ..to see more.
//   else
