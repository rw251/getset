...
function setupItemClick() {
  ...
  function expandChildren(e) {
    ...
    // START - OLD WAY USING MAXHEIGHT
    // const parent = item.parentNode;
    // END - OLD WAY USING MAXHEIGHT
    ...
    if (children) {
      ...
      // START - NEW WAY USING DISPLAY NONE (can't animate but more responsive)
      children.classList.remove('closed');
      children.offsetHeight;
      // END - NEW WAY USING DISPLAY NONE
    }
